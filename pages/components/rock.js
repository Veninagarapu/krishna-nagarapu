...
function Rock() {
  return (
    ...
    <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
      <a href="https://delightful-banoffee-ea4ed7.netlify.app/" target="_blank" rel="noreferrer">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          <h3 className="text-2xl font-semibold">Rock Paper Scissors Game</h3>
          <p className="mt-2 leading-relaxed text-gray-700 dark:text-white/70">
            My first game project. Built using HTML, CSS, and JavaScript, with 2 players, one being the user and the other being the computer itself. As soon as the user picks a card, the result for both players is displayed.
          </p>
      ...
      <img
        ...
        src='./rock.png' // Use your image source here
      />
    </section>
  </div>
