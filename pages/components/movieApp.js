...
function MovieAppProject() {
  return (
    ...
    <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
      <a href="https://lighthearted-dusk-707351.netlify.app/" target="_blank" rel="noreferrer">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          <h3 className="text-2xl font-semibold">Movie App (using TMDB API)</h3>
          <p className="mt-2 leading-relaxed text-gray-700 dark:text-white/70">
            This React project provides the list of upcoming, popular, and top-rated movies. By clicking on any movie, users can see the detailed page of that movie. 
          </p>
          ...
          {/* <div className="link-buttons-container mt-4">
            <button className="portfolio-link">
              <a href="https://lighthearted-dusk-707351.netlify.app/" target="_blank" rel="noreferrer">Live site</a>
            </button>
            <button className="portfolio-link">
              <a href="https://github.com/Veninagarapu/Movieapp" target="_blank" rel="noreferrer">Github Repository</a>
            </button>
          </div> */}
        </div>
      </a>
      <Image
        ...
        src='./movies.png' // Use your movie image source here
      />
    </section>
  </div>
